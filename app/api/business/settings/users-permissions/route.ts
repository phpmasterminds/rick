...
export async function GET(req: Request) {
  try {
    ...
    const response = await axios.get("/business/settings/users-permissions", {
...
export async function POST(req: Request) {
  try {
    ...
    const response = await axios.post("/business/settings/users-permissions", body);
...
export async function PUT(req: Request) {
  try {
    const axios = await createServerAxios();
    const body = await req.json();
	const response = await axios.put(`/business/settings/users-permissions/${body.employee_id}`, body);
...
export async function DELETE(req: Request) {
  try {
    ...
    const response = await axios.delete(`/business/settings/users-permissions/${id}`);
    return NextResponse.json(response.data);
  } catch (error: any) {
