...
const getProductImageUrl = (product: any): string => {
  ...
  // Default fallback
  return 'https://www.okcannashop.com/PF.Site/Apps/core-business/assets/no_image.png';
};
                ...
                >
                  ...
                  <div className="relative h-48 bg-gray-200 dark:bg-slate-800 overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src =
                          'https://www.okcannashop.com/PF.Site/Apps/core-business/assets/no_image.png';
                      }}
                    />
                    {product.thc && (
